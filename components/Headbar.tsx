...
function DropDown({setOptionVisible}:{setOptionVisible:Dispatch<SetStateAction<boolean>>}) {
...
export default function Headbar({setOptionVisible}:{setOptionVisible:Dispatch<SetStateAction<boolean>>}) {
    return <>
        <div className="pt-14">
            <div className="inline-block w-fit text-4xl font-bold">Search properties to rent</div>
            <DropDown  setOptionVisible={setOptionVisible}/>
        </div>
    </>
}